        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="flex justify-center mb-6">
            <div className="flex items-center space-x-2 rounded-full bg-primary/10 px-4 py-2">
              ...
              <span className="text-sm font-medium text-primary">Secure Deposit Protection</span>
            </div>
          </div>
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
            Discover rental properties with built-in deposit protection, secure payments, and dispute resolution. For
            tenants and landlords who value security and transparency.
          </p>
